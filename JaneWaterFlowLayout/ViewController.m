...
@interface ViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, JaneFitHeightFlowLayoutDelegate>
...
- (void)viewDidLoad {
    ...
    JaneFitHeightFlowLayout *layout = [[JaneFitHeightFlowLayout alloc] init];
...
{
    NSLog(@"子视图数量=====%ld",self.view.subviews.count);
    ...
    imageView.frame = CGRectMake(0, 0, 200, 200 * shop.h / shop.w);
